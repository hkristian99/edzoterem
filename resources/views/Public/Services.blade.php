            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <span>Mit kínálunk?</span>
                        <h2>EGYÜTT NÖVELJÜK A KORLÁTAIDAT</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 order-lg-1 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="/assets/frontend/img/services/services-1.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-3 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="/assets/frontend/img/services/services-2.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-8 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="/assets/frontend/img/services/services-4.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-6 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="/assets/frontend/img/services/services-3.jpg" alt="">
                    </div>
                </div>
    ...
    <section class="pricing-section service-pricing spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <span>Bérleteink</span>
                        <h2>Válassz az elérhető bérleteink közül</h2>
                    </div>
                </div>
            </div>
