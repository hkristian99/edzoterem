...
class ProfilController extends Controller
{
    ...
    public function BillingAddressNew(Request $request){
        ...
        return redirect()->route("profile")->with("successBilling", "Az új számlázási cím felvételre került.");
    }
    ...
    public function ShippingAddressNew(Request $request){
        ...
        $messages = [
            ...
            "shipping_phone.required" => "A telefonszám megadása kötelező!"
        ];
        ...
        return redirect()->route("profile")->with("successShipping", "Az új szállítási cím felvételre került.");
    }
